...
"""
word_DTO.py: The python file dedicated to the "Model:DataTransferObject:Word" part of the MVC pattern implemented within
...
class Word(DobryySokilDTO):
    ...
    def set_synonyms(self, synonyms: Optional[list(Word)]):
        """
    ...
    def get_synonyms(self) -> Optional[list(Word)]:
        """
    ...
    def set_homonyms(self, homonyms: Optional[list(Word)]):
        """
    ...
    def get_homonyms(self) -> Optional[list(Word)]:
        """
    ...
    def set_associated_words(self, associated_words: Optional[list(Word)]):
        """
    ...
    def get_associated_words(self) -> Optional[list(Word)]:
        """
